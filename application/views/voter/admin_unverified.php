<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <div class="col-md-12">
                <h1>Daftar
                    <small>Pemilih Tetap Perlu Verifikasi</small>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function show_product(){
		    $.ajax({
		        type  : 'ajax',
		        url   : '<?php echo site_url('unverifiedAdmin/voter_data')?>',
		        async : false,
		        dataType : 'json',
        ...
        $('#btn_save').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('unverifiedAdmin/save')?>",
                dataType : "JSON",
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            var voter_uuid = $('#voter_uuid_edit').val();
			 var r = confirm("Yakin menyerah?");
			  if (r == true) {
					$.ajax({
						type : "POST",
						url  : "<?php echo site_url('unverifiedAdmin/menyerah')?>",
						dataType : "JSON",
         ...
         $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('unverifiedAdmin/update')?>",
                dataType : "JSON",
        ...
        //delete record to database
         $('#btn_delete').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('unverifiedAdmin/delete')?>",
                dataType : "JSON",
